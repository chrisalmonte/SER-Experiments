...
MODEL_NAME = "WavLM_BP_Phoneme"
MODELS_DIR = "/home/imd-temp/projects/SER-Experiments/output/models"
RESUME_FROM = None

model_description = """
WavLM BasePlus finetuned using LoRA for Emotion Intensity classification on LibriSpeech
"""
...
class_params = {
    "output_map": {
    0: "<blank>",    # Silence / CTC Blank
    1: "AA",   # o in odd
    2: "AE",   # a in at
    3: "AH",   # u in hut
    4: "AO",   # ou in ought
    5: "AW",   # ow in cow
    6: "AX",   # a in away (schwa)
    7: "AY",   # y in hide
    8: "B",    # b in bee
    9: "CH",   # ch in cheese
    10: "D",   # d in dog
    11: "DH",  # th in thee
    12: "DX",  # tt in butter (flap)
    13: "EH",  # e in Ed
    14: "ER",  # ur in hurt
    15: "EY",  # a in ate
    16: "F",   # f in fee
